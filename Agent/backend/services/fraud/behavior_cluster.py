...
def evaluate_behavior_anomaly(user_id, claim):
    ...
    key = f"behaviors:{user_id}"
    history = redis_client.lrange(key, 0, WINDOW_SIZE - 1)
    ...
    threshold = 25000  # tuned threshold; adjustable
